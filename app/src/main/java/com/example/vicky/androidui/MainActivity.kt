...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        BtnGiris.setOnClickListener {
            if (TxtKullanici.text.toString().isNotEmpty() && TxtSifre.text.toString().isNotEmpty())
                makePostRequst(this, TxtKullanici.text.toString(), TxtSifre.text.toString()).execute()
        }
    }
